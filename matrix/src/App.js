...
// const matrixClient = sdk.createClient("http://192.168.10.104:8008/");
const matrixClient = sdk.createClient({
  baseUrl: "http://192.168.10.104:8008/",
  accessToken: "syt_d3VoZw_pARGJCPsEHHvclgbcnTm_2wMQfA",
  userId: "@wuhg:wuhg"
});

// matrixClient.login("m.login.password", {"user": "wuhg", "password": "wuhg"}).then((response) => {
